...
import { LoveRelationshipsLordComponent } from "./love-relationships-lord.component";
import { PaymentHistoryComponent } from "./pages/payment-history/payment-history.component";

export const LoveRelationshipsLordRoutes: Routes = [
  {
    path: "",
    component: LoveRelationshipsLordComponent,
    children: [
      {
        path: "dashboard",
