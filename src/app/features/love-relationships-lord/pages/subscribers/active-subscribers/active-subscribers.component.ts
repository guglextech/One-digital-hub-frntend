   ...
   constructor(
    ...
    triggerSearchChange(query: string): void {
     ...
     private fetchData(): void {
       ...
       this.loveRelationshipsLordSvc.subscribers(
           SERVICE_TYPES.LoveRelationships,
     ...
     action(event: any): void {
      ...
      if (event.action === DASHBOARD_ACTIONS.CANCEL_SUBCRIPTION) {
        ...
        this.loveRelationshipsLordSvc.cancelRecurringInvoice(phone, recurringId, SERVICE_TYPES.LoveRelationships).subscribe({
          next: (response) => {
