...
export class LottoStarService extends HotNumbersService {}

// This service extends HotNumbersService to provide specific functionality for LottoStar
...
// to the specific requirements of the LottoStar feature without duplicating code.
