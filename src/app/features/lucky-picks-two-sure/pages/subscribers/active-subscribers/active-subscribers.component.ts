...
export class ActiveSubscribersComponent extends PaginatedTableComponent {
     ...
     constructor(
      ...
      triggerSearchChange(query: string): void {
          ...
          this.currentPage = 1;
          this.LuckyPickTwoSureSvc.forecastHistory(
       ...
       private fetchData(): void {
         ...
         this.LuckyPickTwoSureSvc.subscribers(
             SERVICE_TYPES.TwoSureLp,
       ...
       action(event: any): void {
        ...
        if (event.action === DASHBOARD_ACTIONS.CANCEL_SUBCRIPTION) {
          ...
          this.LuckyPickTwoSureSvc.cancelRecurringInvoice(phone, recurringId, SERVICE_TYPES.TwoSureLp).subscribe({
            next: (response) => {
