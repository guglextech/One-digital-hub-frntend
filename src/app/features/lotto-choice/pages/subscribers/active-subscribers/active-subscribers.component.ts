...
import { HotNumbersService } from "src/app/features/hot-numbers/services/hot-numbers.service";
...
export class ActiveSubscribersComponent extends PaginatedTableComponent {
   ...
   constructor(
     ...
     private fetchData(): void {
       ...
       this.lottoChoiceSvc.subscribers(
           SERVICE_TYPES.LottoChoice,
     ...
     action(event: any): void {
      ...
      if (event.action === DASHBOARD_ACTIONS.CANCEL_SUBCRIPTION) {
        ...
        this.lottoChoiceSvc.cancelRecurringInvoice(phone, recurringId, SERVICE_TYPES.LottoChoice).subscribe({
          next: (response) => {
