...
export class MrTipsService  extends HotNumbersService{} 
// This service extends HotNumbersService to provide specific functionality for MrTips
...
// to the specific requirements of the MrTips feature without duplicating code.